        ...
        <div className="flex flex-col items-center text-center gap-14">
            ...
            <div className="flex items-center gap-2" style={{ animation: "fade-slide-up 0.6s ease-out 0.4s both" }}>
              {profile.social.github && (
                <Button variant="ghost" size="icon" asChild className="rounded-full hover:text-[hsl(var(--ark-blue))] transition-all duration-300 hover:scale-110">
            ...
            <Button variant="ghost" size="icon" asChild className="rounded-full animate-bounce-gentle group mt-2">
              <a href="#about">
